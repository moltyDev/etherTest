...
const LAUNCHES_CACHE_TTL_MS = 8_000;
const POOL_SNAPSHOT_CACHE_TTL_MS = 5_000;
const STATS_CACHE_TTL_MS = 12_000;
const TOKEN_CACHE_TTL_MS = 4_000;
...
const GECKO_TRADES_CACHE_TTL_MS = 12_000;
const DEX_TOKEN_CACHE_TTL_MS = 10_000;
